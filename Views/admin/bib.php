...
<main class="container">
    <section class="user-management">
        <h2>Ajouter un Nouvel Bibliothecaire</h2>
        <form id="add-user-form" action="add_user.php" method="post">
            ...
            <input type="hidden" name="status" value="bibliothecaire">
    ...
    <section class="user-list">
        ...
        <table>
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<tr><td colspan='4'>Aucun Bibiothecaire trouvé</td></tr>";
            }
